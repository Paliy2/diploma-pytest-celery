...
CELERY_ELASTICSEARCH_BACKEND = "celery_elasticsearch_backend"
...
DEFAULT_BACKENDS = (DEFAULT_REDIS_BACKEND, DEFAULT_ELASTICSEARCH_BACKEND)
DEFAULT_BROKERS = (
...
ALL_CELERY_BACKENDS = (CELERY_REDIS_BACKEND, CELERY_ELASTICSEARCH_BACKEND)
ALL_CELERY_BROKERS = (
    CELERY_REDIS_BROKER,
